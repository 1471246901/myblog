...
![image-20200428170025106](https://raw.githubusercontent.com/1471246901/myblog/master/img/image-20200428170025106.png)
...
在Dao接口所在包 编写对应的类,实现功能并标注注解`@Repository`  **或者添加 `@mapper `  后不需要在启动类添加 @MapperScan("Dao接口所在包")**
